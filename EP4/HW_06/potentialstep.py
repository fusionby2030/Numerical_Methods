...
class Wave_Packet():
    def __init__(self, n_points, dt, sigma0=0.5, k0=1.0, x0=-150.0, x_begin=-200.0, x_end=200.0,
                barrier_height=10.0, barrier_width=100):
        ...
        self.psi = (sp.exp(1.0j * k0 * self.x))*self.psi
        self.psi = ((2.0 * sp.pi * sigma0**2)**(-0.25))*self.psi
...
wave_packet = Wave_Packet(n_points=500, dt=0.5)
