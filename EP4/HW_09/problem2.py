...
ax[0].legend()
plt.tight_layout()
plt.savefig('/home/fusionby2030/Uni_Ausgabe/Semester4/Labs/Reports/data/problem2.png')
plt.savefig('/home/fusionby2030/Uni_Ausgabe/Semester4/EP4/HW_09/files/problem2.png')
